...
**Hello Rails ** is a frontend  for a displaying random greetings.

## Backend

The backend was made with rails on ruby and can be found [here](https://github.com/donmark2k/hello-rails-back-end)
...
```sh
 https://github.com/donmark2k/hello_rails_frontend.git
```
...
```sh
  cd your-folder
  git clone https://github.com/donmark2k/hello_rails_frontend.git 
```
...
Feel free to check the [issues page](https://github.com/donmark2k/hello_rails_frontend/issues).
